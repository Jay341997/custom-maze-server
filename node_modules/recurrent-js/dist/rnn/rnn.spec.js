...
describe('Deep Recurrent Neural Network (RNN):', () => {
    ...
    describe('Instantiation:', () => {
        describe('Configuration with NetOpts:', () => {
            ...
            describe('Hidden Layer:', () => {
                ...
                const expectHiddenStatelessWeightMatricesToHaveColsOfSizeOfPrecedingLayerAndRowsOfConfiguredLength = (inputSize, hiddenUnits) => {
                ...
                const expectHiddenStatefulWeightMatricesToHaveSquaredDimensions = (inputSize, hiddenUnits) => {
                    let expectedRows, expectedCols;
                    for (let i = 0; i < config.architecture.hiddenUnits.length; i++) {
                ...
                const expectHiddenBiasMatricesToBeVectorWithRowsOfSizeOfPrecedingLayer = (inputSize, hiddenUnits) => {
                    let expectedRows;
    ...
    describe('Backpropagation:', () => {
        ...
        describe('Update:', () => {
            describe('Hidden Layer:', () => {
                ...
                const expectUpdateOfLayersMethodsToHaveBeenCalledWithValue = (value) => {
                    for (let i = 0; i < config.architecture.hiddenUnits.length; i++) {
    ...
    describe('Forward Pass:', () => {
        const netOpts = { architecture: { inputSize: 2, hiddenUnits: [3, 4], outputSize: 3 } };
        let sut;
        let input;
        beforeEach(() => {
            patchFillRandn();
            input = new __1.Mat(2, 1);
            input.setFrom([1, 0]);
            sut = new __1.RNN(netOpts);
        });
        describe('Stateless:', () => {
        ...
        const patchFillRandn = () => {
            spyOn(__1.Utils, 'fillRandn').and.callFake(fakeFillRandn);
        };
        const fakeFillRandn = (arr) => {
            __1.Utils.fillConst(arr, 1);
        };
    });
});
//# sourceMappingURL=rnn.spec.js.map