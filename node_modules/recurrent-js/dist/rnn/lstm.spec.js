    ...
    describe('Instantiation:', () => {
        describe('Configuration with NetOpts:', () => {
            ...
            describe('Hidden Layer:', () => {
                ...
                const expectHiddenWeightMatricesToHaveColsOfSizeOfPrecedingLayerAndRowsOfConfiguredLength = (inputSize, hiddenUnits) => {
                ...
                const expectHiddenWeightMatricesForPrecedingActivationToHaveQuadraticDimensionsAccordingToHiddenUnits = (expected) => {
                    for (let i = 0; i < config.architecture.hiddenUnits.length; i++) {
...
//# sourceMappingURL=lstm.spec.js.map