...
describe('Deep Neural Network (DNN):', () => {
    ...
    describe('Instantiation:', () => {
        describe('Configuration with NetOpts:', () => {
            ...
            describe('Hidden Layer:', () => {
                ...
                const expectHiddenBiasMatricesToHaveRowsOfSizeOfPrecedingLayerAndColsOfSize1 = (inputSize, hiddenUnits) => {
                    let expectedRows;
    ...
    describe('Backpropagation:', () => {
        ...
        const patchBackwardSequenceAsSpies = () => {
            spyOn(sut['graph'], 'backward');
            spyOn(sut['graph'], 'forgetCurrentSequence');
            spyOn(sut, 'updateWeights');
            spyOn(sut, 'propagateLossIntoDecoderLayer');
        };
    });
    describe('Forward Pass:', () => {
        ...
        const patchFillRandn = () => {
            spyOn(__1.Utils, 'fillRandn').and.callFake(fillConstOnes);
        };
        ...
        const fillMatConstOnes = (mat) => {
            const out = new __1.Mat(mat.rows, 1);
            fillConstOnes(out.w);
            return out;
        };
    });
});
//# sourceMappingURL=dnn.spec.js.map